      ...
      {loading ? (
        ...
        >
          ...
          <Box
            sx={{
              bgcolor: (theme) =>
                theme.palette[color[Math.floor(Math.random() * 5)]].lighter,
              p: 6,
              mb: 3,
              width: "100%",
            }}
          >
            <Typography variant="h3">{expenseDetails?.expenseName}</Typography>
          ...
          <Grid container spacing={3} p={4}>
            ...
            <Grid item md={6} xs={12}>
              <Typography variant="h6">Date : {expenseDate}</Typography>
            </Grid>
            ...
            <Grid item md={6} xs={12}>
              <Typography variant="h6">
                ...
                {currencyFind(expenseDetails?.expenseCurrency) +
                  " " +
                  convertToCurrency(expenseDetails?.expenseAmount)}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12}>
              ...
              >
                ...
                {currencyFind(expenseDetails?.expenseCurrency) +
                  " " +
                  convertToCurrency(expenseDetails?.expensePerMember)}
              </Typography>
            </Grid>
